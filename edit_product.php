...
if(isset($_GET['edit_product'])){
    ...
    $get_p_cat = "select * from product_categories where p_cat_id=' $p_id '";
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                     <label class="col-md-3 control-label">Product Caterory</label>
                     <div class="col-md-6">
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         ...
                         <br>
                         <img width ="70"src="product_images/<?php echo $p_image1; ?>" alt="<?php echo $p_image1; ?>">
                     </div>
                 </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         ...
                         <br>
                         <img width ="70"src="product_images/<?php echo $p_image2; ?>" alt="<?php echo $p_image2; ?>">
                     </div>
                 </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         ...
                         <br>
                         <img width ="70"src="product_images/<?php echo $p_image3; ?>" alt="<?php echo $p_image3; ?>">
                     </div>
                 </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         <textarea name="product_desc" cols="19" rows="6" class="form-control"value="<?php echo $p_desc;?>"></textarea>
                     </div>
                 </div>
...
if(isset($_POST['update'])){
    ...
    if($run_product){
        echo"<script>alert('Product has been Update Successfull.')</script>";
