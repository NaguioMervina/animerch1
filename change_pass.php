...
if(isset($_POST['submit'])){
    ...
    $c__new_pass_again = $_POST['new_pass_again'];
    ...
    if($c_new_pass!=$c__new_pass_again ){
        echo "<script>alert('Sorry, your current password did not match.')</script>"; 
        exit();
    }
    ...
    if( $run_c_pass){
        echo "<script>alert('Your password has been update')</script>";
