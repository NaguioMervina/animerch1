                    ...
                    <table class="table table-hover table-stripped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="admin.php?edit_p_cat=<?php echo$p_cat_id;?>"><i class="fa fa-pencil"></i>  Edit</a></td> 
                                <td><a href="admin.php?delete_p_cat=<?php echo$p_cat_id;?>"><i class="fa fa-trash"></i> Delete</a></td> 
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
